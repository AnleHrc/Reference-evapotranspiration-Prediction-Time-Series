...
def LSTM_ET0(filename):
    ...
    def N_LSTM(optimizer='Adam', batch_size=32, epochs=40):
        model = Sequential()
        model.add(LSTM(150, activation='relu', input_shape=(n_past, sacler_data_len)))
    ...
    # mode = 'w' :覆盖.mode= 'a' ： 追加
    with open('lstm_58693_station_statistical_indicator.csv',mode='a',newline='') as file:
