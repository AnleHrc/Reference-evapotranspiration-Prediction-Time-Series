...
if __name__ == '__main__':
    ...
    for day in days:
       ...
       reshape1,finally_y_true,finally_pre_rsult,day,n_steps_out = ceemdan_cnn(day,model,station_id)
       print('This is ',day,'-th for prediction et0')
       print('------------------',day,'---------------------')
       ...
       plot_save_true_prediction(reshape1,finally_y_true,finally_pre_rsult,day,n_steps_out,formatted_time,model,station_id)
