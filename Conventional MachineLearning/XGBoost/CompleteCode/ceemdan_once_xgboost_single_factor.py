...
def ceemdan_cnn(day):
    ...
    reshape1 = 0
    IMF = pd.read_excel('../../../Data/CEEMDAN/SingleFactor_20years_ET0/58618/'+'CEEMDAN_58618 Station_'+day+'.xlsx',header=None)
...
def plot_save_true_prediction(reshape1,finally_y_true,finally_pre_rsult,day,n_steps_out,formatted_time):
    ...
    # 保存为CSV文件
    true_file_path = "../Result/CEEMDAN_Single_Factor_20_years/58618/"+day+"_day_CEEMDAN_IMF" + str(reshape2 - 1) + "-XGBoost_true.csv"
    ...
    prediction_file_path = "../Result/CEEMDAN_Single_Factor_20_years/58618/"+day+"_day_CEEMDAN_IMF" + str(reshape2 - 1) + "-XGBoost_prediction.csv"
    # 保存为CSV文件
    ...
    with open('ceemdan_xgboost_58618_statistical_indicator.csv',mode='a',newline='') as file:
