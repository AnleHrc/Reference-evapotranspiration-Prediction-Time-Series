...
def plot_save_true_prediction(reshape1,finally_y_true,finally_pre_rsult,day,n_steps_out,formatted_time):
    ...
    # 保存为CSV文件
    true_file_path = "Result/CEEMDAN_Single_Factor_20_years/58606/"+day+"_day_CEEMDAN_IMF" + str(reshape2 - 1) + "-RF_true.csv"
    ...
    prediction_file_path = "Result/CEEMDAN_Single_Factor_20_years/58606/"+day+"_day_CEEMDAN_IMF" + str(reshape2 - 1) + "-RF_prediction.csv"
    # 保存为CSV文件
    ...
    with open('ceemdan_rf_58606_statistical_indicator.csv',mode='a',newline='') as file:
